"""
Django settings for myecomrceapp project.
...
SECRET_KEY = '(e0%n5w$jq!6&mb@fs&5ze&cppf5^1o$xoi=%%(u#6=mko$b($'
...
ROOT_URLCONF = 'myecomrceapp.urls'
...
WSGI_APPLICATION = 'myecomrceapp.wsgi.application'
